...
local os = require("os")
local mlf = require "mts_log_format"
...
local grammar = mlf.build_mts_grammar()
...
function process_message ()
    ...
    msg.Timestamp = os.time(fields[1]) --fields.time
    fields.day = nil
    ...
    for field in pairs(fields) do
        ...
        table.insert(tags, field.."="..tostring(value))
    end
    ...
    if tags and #tags > 0 then
        ...
        x = string.format("%s",table.concat(tags, ","))
    ...
    msg.Type = "MTSLog"
    msg.Fields = fields[1]
    -- msg.Payload = cjson.encode(msg)-- x -- log
    inject_message(msg)
    return 0
end
