...
var endpointUrl = "opc.tcp://" + require("os").hostname().toLowerCase() + ":49380";
...
async.series([
    ...
    function(callback) {
       the_session.readVariableValue(["ns=2;s=Channel1.Device1.MT","ns=2;s=Channel1.Device1.Tag1"], function(err,dataValues) {
           if (!err) {
    ...
    function(callback) {
       ...
       monitoredItem.on("changed",function(dataValue){
          console.log(" % Channel1.Device1.MT = ",dataValue.value.value);
       });
