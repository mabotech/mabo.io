...
class SpotWorker(object):
    ...
    order by id desc""" % (esn)
        ...
        if row != None:
            ...
            debug.log("can't find esn:%s in ng db" %(esn))
...
class OPCClient(object):
    ...
    def __init__(self):        
        ...
        group_names = ["BLI.42700M","BLI.42701S"]
        ...
        self.opc = OPCProxy(host, port, provider, timeout)
        ...
        for group_name in group_names:
            ...
            self.opc.create_group(group_name, points)


    def read(self, group_name):
        
        v = self.opc.read(group_name)
