...
##Load image
img = cv2.imread("N9.png") 
grey = cv2.imread("N9.png",0) #0 for grayscale
...
circles = cv2.HoughCircles(thresh,cv2.cv.CV_HOUGH_GRADIENT,1,75,param1=50,param2=13,minRadius=0,maxRadius=0)
for i in circles[0,:]:
